...
class AboutSandwichCode < EdgeCase::Koan
  ...
  def test_counting_lines
    assert_equal 4, count_lines("/Users/admin/src/ruby_koans/koans/example_file.txt")
  end
  ...
  def test_finding_lines
    assert_equal "test\n", find_line("/Users/admin/src/ruby_koans/koans/example_file.txt")
  end
  ...
  def test_counting_lines2
    assert_equal 4, count_lines2("/Users/admin/src/ruby_koans/koans/example_file.txt")
  end
  ...
  def test_finding_lines2
    assert_equal "test\n", find_line2("/Users/admin/src/ruby_koans/koans/example_file.txt")
  end
  ...
  def test_open_handles_the_file_sandwich_when_given_a_block
    assert_equal 4, count_lines3("/Users/admin/src/ruby_koans/koans/example_file.txt")
  end
